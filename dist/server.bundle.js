...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_http__ = __webpack_require__(11);
...
const httpServer = __WEBPACK_IMPORTED_MODULE_1_http___default.a.createServer(app);
const port = "5002";
const wds = "4000";
...
"use strict";
/* WEBPACK VAR INJECTION */(function(__dirname) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_express__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_express___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_express__);
...
router.use('/assets', __WEBPACK_IMPORTED_MODULE_0_express___default.a.static(__WEBPACK_IMPORTED_MODULE_1_path___default.a.join(__dirname, 'assets')));
router.get('/*', (req, res) => {
    res.sendFile(__WEBPACK_IMPORTED_MODULE_1_path___default.a.resolve(__dirname, 'index.html'));
});
